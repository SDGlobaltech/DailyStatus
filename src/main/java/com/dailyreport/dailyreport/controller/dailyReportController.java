...
//	  }
	 ...
	 @PostMapping("/create")
	  public String create(@RequestBody List<CustomerUI>  customer){
	     ...
	     for (CustomerUI customerUI : customer) {
			 ...
			 */
			Customer customerSave=repository.save(new Customer(customerUI.getFirstName(), customerUI.getLastName(),customerUI.getDate(),customerUI.getStatusDate(),customerUI.getClientName(),customerUI.getStatsDate()));
	 ...
	 @GetMapping("/findall")
	  public List<CustomerUI> findAll(){
	      ...
	      customerUI.add(new CustomerUI(customer.getFirstName(),customer.getLastName(),customer.getDate(),customer.getStatusDate(),customer.getClientName(),customer.getStatsDate()));
	      }
	      return customerUI;
	  }
